 ...
 */
public class MoviesDataParserTest extends TestCase {


    static String MOVIES_DATA = "{" +
            "  \"page\": 1," +
            "  \"results\": [" +
            "    {" +
            "      \"adult\": false," +
    ...
    public void testMadMaxVoteCount() throws JSONException {
        assertEquals(815, MoviesFragment.getVoteCountForItemInJson(MOVIES_DATA,1));

    }
    public void testKingsmanVoteCount() throws JSONException {
        assertEquals(1044, MoviesFragment.getVoteCountForItemInJson(MOVIES_DATA, 5));
